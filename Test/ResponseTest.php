...
class ResponseTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testConstruct()
	{
		...
		$this->assertInstanceOf('Asika\Http\Stream\Stream', $res->getBody());
		$this->assertEquals('php://memory', $res->getBody()->getMetadata('uri'));
		$this->assertEquals(200, $res->getStatusCode());
		$this->assertEquals(array(), $res->getHeaders());

		// Test with params
		$body = fopen($tmpfile = tempnam(sys_get_temp_dir(), 'http'), 'wb+');
		$headers = array(
	 ...
	 * @return void
	 *
	 * @covers Asika\Http\Response::getStatusCode
	 * @covers Asika\Http\Response::withStatus
	 */
	 ...
	 * @return void
	 *
	 * @covers Asika\Http\Response::getReasonPhrase
	 */
